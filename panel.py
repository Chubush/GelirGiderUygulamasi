...
"}")
        ...
        self.gunluk_toplamgiren_2 = QtWidgets.QLineEdit(self.tab_2)
        self.gunluk_toplamgiren_2.setEnabled(True)
        self.gunluk_toplamgiren_2.setGeometry(QtCore.QRect(1570, 670, 241, 71))
        font = QtGui.QFont()
        font.setPointSize(28)
        font.setBold(True)
        font.setWeight(75)
        self.gunluk_toplamgiren_2.setFont(font)
        self.gunluk_toplamgiren_2.setMouseTracking(False)
        self.gunluk_toplamgiren_2.setTabletTracking(False)
        self.gunluk_toplamgiren_2.setStyleSheet("*{ background-color: rgb(124, 73, 72);; color: white; border-radius: 10px;}")
        self.gunluk_toplamgiren_2.setReadOnly(True)
        self.gunluk_toplamgiren_2.setPlaceholderText("")
        self.gunluk_toplamgiren_2.setObjectName("gunluk_toplamgiren_2")
...
"}")
        ...
        MainWindow.setTabOrder(self.btn_gider_ara, self.gunluk_toplamgiren_2)
        MainWindow.setTabOrder(self.gunluk_toplamgiren_2, self.btn_gelir_sil)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.gunluk_toplamgiren_2.setText(_translate("MainWindow", "265055656"))
